...
@section('title')<title>Member - Fine Food Group Admin</title>@stop
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="admin-add-body">
                    ...
                    <input class="form-control" type="password" ng-model="adminAddPassword"
                           value=""/></br>
                    <label>Address</label>
                    <input class="form-control" type="text" value="" ng-model="adminAddAddress"/></br>
                    <label>Level</label>
    ...
    <div class="modal fade" id="admin-edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Detail of Member</h4>
                </div>
                <div class="modal-body" id="admin-edit-body" >
                    ...
                    <label>Address</label>
                    <input class="form-control" type="text" value="" ng-model="adminAddress"/></br>
                    <label>Level</label>
