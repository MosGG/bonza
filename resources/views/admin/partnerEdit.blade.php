...
@section('title')<title>Partner Edit - The Map Admin</title>@stop
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="from-group">
                                ...
                                <input type="text" ng-model="portfolio.description" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="from-group">
                                ...
                                <input type="text" ng-model="portfolio.description_cn" class="form-control">
                            </div>
                        </div>
                    </div>
...
@section('js-function')
    ...
    <script>
        ...
        $(function() {
            ...
            // $('#project-content').froalaEditor('html.set', {!! $portfolio !!}[0]['brief']);
            // $('#project-content-cn').froalaEditor('html.set', {!! $portfolio !!}[0]['brief_cn']);
        });
        ...
        app.controller('adminCtrl', function($scope, $http) {
            ...
            $scope.update = function(){
                // console.log($scope.portfolio['content']);
